$(document).ready(function(){
	    	...
	    	var currentTh; 
    	 	...
    	 	for (var i=1; i<7; i++) {
    	 		...
    	 		$("#n" + i).mouseover( function() {
    	 			...
    	 			currentTh = id;
    	 			//$("#th" + id).animate({ opacity: '1' }, 500);
    	 			$("#th" + id).show();
    	 		});

	    	 	$("#n" + i).mouseout( function() {
	    	 		//$("#th" + currentTh).css({ opacity: 0 })
	    	 		$("#th" + currentTh).hide();
	    	 	});
	    	...
	    	//if (theref != undefined) {
			//	dfmNav.initParams('mode|home', 'site|' + theref, 'pageTitle| ', 'leaderboard|true'); 
			//} else {
			//	dfmNav.initParams('mode|home', 'site|mercurynews', 'pageTitle| ', 'leaderboard|true'); 
			//}
